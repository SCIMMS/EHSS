...
class SparsePrefixMaterialCollisionField(MaterialCollisionField):
    def __init__(self,bound,observed,physical_model,bins=2,checked_observations=False,allow_reentry=True,layout=None,vector_validation=True,prefix_pool=None):
        ...
        if len(missing):
            ...
            if prefix_pool is None:
                ...
                prefix=prefix_pool.trace(missing,physical_model,sub,self.keys,self.active,bank.groups,self.rotations,bins,bank.cap,allow_reentry)
